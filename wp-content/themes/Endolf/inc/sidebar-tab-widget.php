	...
	public function widget( $args ) {
		...
		<div id="side-tab">
			...
			<ul id="myTab" class="nav nav-tabs nav-justified">
				<li class="active"> <a data-toggle="tab" href="#latest-tab"> آخرین مطالب </a></li>
				<li> <a data-toggle="tab" href="#popular-tab"> پربازدیدترین </a></li>
				<li> <a data-toggle="tab" href="#comments-tab"> دیدگاه ها </a></li>
			</ul>
